...
# Change to project root directory so that the relative paths in the MCP
# server config (e.g. "agent/tools/Analysis.py", "benchmark/question.json")
# resolve correctly.
...
def load_langchain_config(config_path=None):
    """Load configuration and initialize LangChain components"""
    if config_path is None:
        # Use path relative to project root
        project_root = Path(__file__).parent.parent
        config_path = project_root / 'agent' / 'config_deepseek.json'
